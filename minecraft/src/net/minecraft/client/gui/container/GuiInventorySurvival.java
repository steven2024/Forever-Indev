...
public final class GuiInventorySurvival extends GuiContainer {
    ...
    public GuiInventorySurvival(IInventory inventory) {
     ...
     // Initialize container slots
        this.inventorySlots.add(new SlotAccessory(this, inventory, 36, 6, 26, SlotAccessory.ACCESSORY_QUIVER)); // Quiver slot
        this.inventorySlots.add(new SlotAccessory(this, inventory, 37, 6, 44, SlotAccessory.ACCESSORY_ARROW));  // Arrow slot
        this.inventorySlots.add(new SlotAccessory(this, inventory, 38, 6, 8, SlotAccessory.ACCESSORY_SHIELD));  // Shield slot (index 38)
