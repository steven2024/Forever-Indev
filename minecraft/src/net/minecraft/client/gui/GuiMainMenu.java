...
public final class GuiMainMenu extends GuiScreen {
    ...
    public final void initGui() {
        ...
        int buttonSpacing = 24; // Space between the buttons
        
        // Positioning the buttons with consistent spacing
        this.controlList.add(new GuiButtonText(1, this.width / 2 - 100, this.height / 4 + 48, "Generate new level..."));
        this.controlList.add(new GuiButtonText(2, this.width / 2 - 100, this.height / 4 + 48 + buttonSpacing, "Load level..."));
        this.controlList.add(new GuiButtonText(0, this.width / 2 - 100, this.height / 4 + 48 + 2 * buttonSpacing, "Options..."));
        this.controlList.add(new GuiButtonText(4, this.width / 2 - 100, this.height / 4 + 48 + 3 * buttonSpacing, "Top Scores"));
        this.controlList.add(new GuiButtonText(3, this.width / 2 - 100, this.height / 4 + 48 + 4 * buttonSpacing, "Exit Game"));
    ...
    protected final void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 0:
                ...
                break; // Ensure the switch doesn't fall through to the next case
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                this.mc.displayGuiScreen(new GuiTopScores(this)); // Pass the current instance or the appropriate GuiScreen
                break;
        }
    }
